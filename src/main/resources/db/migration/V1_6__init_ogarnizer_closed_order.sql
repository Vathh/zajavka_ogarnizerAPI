CREATE TABLE ogarnizer_closed_order
(
    closed_order_id         SERIAL          NOT NULL,
    ...
    CONSTRAINT fk_closed_order_created_by_user
        FOREIGN KEY (created_by_user_id)
            REFERENCES ogarnizer_user (user_id) ON DELETE CASCADE,
    CONSTRAINT fk_closed_order_client
        FOREIGN KEY (client_id)
            REFERENCES ogarnizer_client (client_id) ON DELETE CASCADE,
    CONSTRAINT fk_closed_order_closed_by_user
